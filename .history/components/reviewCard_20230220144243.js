...
export default function RevCard({
    ...
    return (<div style={{justifyContent:'center',display:'flex', width:"50%", height:'100%', backgroundColor:'#C5CAA9',  borderRadius:20, marginBottom:40, paddingRight:20, paddingBottom:8}}>
