...
export default function RevCard({
    ...
    return (<div style={{justifyContent:'center',display:'flex', backgroundColor:'#C5CAA9',  borderRadius:20, marginBottom:40, paddingRight:20, paddingBottom:8}}>
        
        <div style={{display:'flex', flexDirection:'row', height:'100%', padding:10}}>
            <Image alt="hello" style={{display:'flex', width:'15%', height:"15%", marginTop:"4%", marginLeft:10}} src="Popular.png"/> 
